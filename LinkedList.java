...
public class LinkedList<T> implements Iterable<T>
{
	...
	private class Node
	{
		...
		private Node copyNode(Node node, LinkedList<T> original) {
            if (node == null) 
            {
                return original;
            }
            
            Node copy = new Node(head.getThing());
            
            if(current != null)
            {
            	current.setNext(copyNode());
            }
        }
	}
	...
	private class LLIterator implements Iterator<T>
	{
		...
		/*public void remove(int index)
		{
			...
			{
				head = head.next;				// set the head node to the node next to the head
				return;
			}
	...
	/* returns the index of the node containing the value t */
	...
	/* returns a new list that is an identical copy of this list */
	public LinkedList<T> copy()
	{
		return copyRecursive(first, new LinkedList<T>());
	}
